...
int GenerateRandom() { return 1; }

// class TextFiture : public ::testing::TestWithParam<int>{};

// class OthelloStateTestFixture : public ::testing::TestWithParam<
    // std::tuple<
        // Common::Piece position[OthelloState::ROWS][OthelloState::COLS], 
        // int skippedTurns
    // >> 
// {
    // OthelloStateTestFixture(){}
