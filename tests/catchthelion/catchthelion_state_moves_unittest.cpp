...
TEST(catchthelion_unittest, SimulateAndUndo_Multiple_Moves_Captures_Drops)
{
    ...
    auto move1 = CatchTheLionMove(P1, Common::CatchTheLionPieceType::CHICK, 1, 1, 2, 1, Common::CatchTheLionPieceType::CHICK);
    ...
    auto move2 = CatchTheLionMove(P2, Common::CatchTheLionPieceType::LION, 3, 1, 2, 1, Common::CatchTheLionPieceType::CHICK);
    ...
    auto move3 = CatchTheLionMove(P1, Common::CatchTheLionPieceType::GIRAFFE, 0, 0, 1, 0);
    ...
    auto move4 = CatchTheLionMove(P2, Common::CatchTheLionPieceType::CHICK, 1, 2);
    ...
    auto move5 = CatchTheLionMove(P1, Common::CatchTheLionPieceType::GIRAFFE, 1, 0, 1, 1);
    ...
    auto move6 = CatchTheLionMove(P2, Common::CatchTheLionPieceType::CHICK, 1, 2, 0, 2, Common::CatchTheLionPieceType::ELEPHANT);
    ...
    auto move7 = CatchTheLionMove(P1, Common::CatchTheLionPieceType::GIRAFFE, 1, 1, 2, 1, Common::CatchTheLionPieceType::LION);
