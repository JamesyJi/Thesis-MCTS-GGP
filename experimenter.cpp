...
int main(void)
{
    ...
    using Model4T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth8>;
    auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("connect4_6v8");
    resource = Common::TimeResource(1);
    manager1.StartExperiment(resource, 1);

    using Model5T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth8>;
    using Model6T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth6>;
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("connect4_8v6");
    resource = Common::TimeResource(1);
    manager2.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager3.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager4.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager5.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager6.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager7.StartExperiment(resource, 1);
    ...
    resource = Common::TimeResource(1);
    manager8.StartExperiment(resource, 1);
