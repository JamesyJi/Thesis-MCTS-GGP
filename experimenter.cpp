...
int main(void)
{
    ...
    // auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("othello_Dv3_A");
    // resource = Common::TimeResource(1);
    ...
    // auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("othello_3vD_A");
    // resource = Common::TimeResource(1);
    ...
    // auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("othello_Dv3_B");
    // resource = Common::TimeResource(1);
    ...
    // auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("othello_3vD_B");
    // resource = Common::TimeResource(1);
    ...
    // auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("othello_Dv3_C");
    // resource = Common::TimeResource(1);
    ...
    // auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("othello_3vD_C");
    // resource = Common::TimeResource(1);
    ...
    // auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("othello_Dv3_D");
    // resource = Common::TimeResource(1);
    ...
    // auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("othello_3vD_D");
    // resource = Common::TimeResource(1);
    ...
    // auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("othello_Dv3_E");
    // resource = Common::TimeResource(1);
    ...
    // auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("othello_3vD_E");
    // resource = Common::TimeResource(1);
