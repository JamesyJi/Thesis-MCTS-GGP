...
int main(void)
{
    ...
    auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("catchthelion_Dv3_A");
    resource = Common::TimeResource(1);
    manager0.StartExperiment(resource, 75);
    ...
    auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("catchthelion_SvD_A");
    resource = Common::TimeResource(1);
    manager1.StartExperiment(resource, 75);
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("catchthelion_Dv3_B");
    resource = Common::TimeResource(1);
    manager2.StartExperiment(resource, 75);
    ...
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("catchthelion_SvD_B");
    resource = Common::TimeResource(1);
    manager3.StartExperiment(resource, 75);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("catchthelion_Dv3_C");
    resource = Common::TimeResource(1);
    manager4.StartExperiment(resource, 75);
    ...
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("catchthelion_SvD_C");
    resource = Common::TimeResource(1);
    manager5.StartExperiment(resource, 75);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("catchthelion_Dv3_D");
    resource = Common::TimeResource(1);
    manager6.StartExperiment(resource, 75);
    ...
    auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("catchthelion_SvD_D");
    resource = Common::TimeResource(1);
    manager7.StartExperiment(resource, 75);
    ...
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("catchthelion_Dv3_E");
    resource = Common::TimeResource(1);
    manager8.StartExperiment(resource, 75);
    ...
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("catchthelion_SvD_E");
    resource = Common::TimeResource(1);
    manager9.StartExperiment(resource, 75);
    ...
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("catchthelion_Dv3_F");
    resource = Common::TimeResource(1);
    manager10.StartExperiment(resource, 75);
    ...
    auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("catchthelion_SvD_F");
    resource = Common::TimeResource(1);
    manager11.StartExperiment(resource, 75);
    ...
    // auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("catchthelion_Dv3_G");
    // resource = Common::TimeResource(1);
    // manager12.StartExperiment(resource, 75);
    ...
    // auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("catchthelion_SvD_G");
    // resource = Common::TimeResource(1);
    // manager13.StartExperiment(resource, 75);
    ...
    // auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("catchthelion_Dv3_H");
    // resource = Common::TimeResource(1);
    // manager14.StartExperiment(resource, 75);
    ...
    // auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("catchthelion_SvD_H");
    // resource = Common::TimeResource(1);
    // manager15.StartExperiment(resource, 75);
    ...
    // auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("catchthelion_Dv3_I");
    // resource = Common::TimeResource(1);
    // manager16.StartExperiment(resource, 75);
    ...
    // auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("catchthelion_SvD_I");
    // resource = Common::TimeResource(1);
    // manager17.StartExperiment(resource, 75);
    ...
    // auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("catchthelion_Dv3_J");
    // resource = Common::TimeResource(1);
    // manager18.StartExperiment(resource, 75);
    ...
    // auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("catchthelion_SvD_J");
    // resource = Common::TimeResource(1);
    // manager19.StartExperiment(resource, 75);
