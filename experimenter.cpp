...
int main(void)
{
    ...
    using Model2T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("othello_Dv1_A");
    resource = Common::TimeResource(1);
    ...
    auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("othello_1vD_A");
    resource = Common::TimeResource(1);
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("othello_Dv1_B");
    resource = Common::TimeResource(1);
    ...
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("othello_1vD_B");
    resource = Common::TimeResource(1);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("othello_Dv1_C");
    resource = Common::TimeResource(1);
    ...
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("othello_1vD_C");
    resource = Common::TimeResource(1);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("othello_Dv1_D");
    resource = Common::TimeResource(1);
    manager6.StartExperiment(resource, 200);

    using Model15T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model16T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnD<StateT>>;
    auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("othello_1vD_D");
    resource = Common::TimeResource(1);
    manager7.StartExperiment(resource, 200);

    using Model17T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnE<StateT>>;
    using Model18T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("othello_Dv1_E");
    resource = Common::TimeResource(1);
    manager8.StartExperiment(resource, 200);

    using Model19T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model20T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnE<StateT>>;
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("othello_1vD_E");
    resource = Common::TimeResource(1);
    manager9.StartExperiment(resource, 200);

    using Model21T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnF<StateT>>;
    using Model22T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("othello_Dv1_F");
    resource = Common::TimeResource(1);
    manager10.StartExperiment(resource, 200);

    using Model23T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model24T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnF<StateT>>;
    auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("othello_1vD_F");
    resource = Common::TimeResource(1);
    ...
    using Model26T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("othello_Dv1_G");
    resource = Common::TimeResource(1);
    manager12.StartExperiment(resource, 200);

    using Model27T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model28T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnG<StateT>>;
    auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("othello_1vD_G");
    resource = Common::TimeResource(1);
    ...
    using Model30T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("othello_Dv1_H");
    resource = Common::TimeResource(1);
    manager14.StartExperiment(resource, 200);

    using Model31T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model32T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnH<StateT>>;
    auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("othello_1vD_H");
    resource = Common::TimeResource(1);
    ...
    using Model34T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("othello_Dv1_I");
    resource = Common::TimeResource(1);
    manager16.StartExperiment(resource, 200);

    using Model35T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model36T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnI<StateT>>;
    auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("othello_1vD_I");
    resource = Common::TimeResource(1);
    ...
    using Model38T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("othello_Dv1_J");
    resource = Common::TimeResource(1);
    manager18.StartExperiment(resource, 200);

    using Model39T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    using Model40T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnJ<StateT>>;
    auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("othello_1vD_J");
    resource = Common::TimeResource(1);
