...
int main(void)
{
    ...
    auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("othello_DvS_A");
    resource = Common::TimeResource(1);
    ...
    auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("othello_SvD_A");
    resource = Common::TimeResource(1);
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("othello_DvS_B");
    resource = Common::TimeResource(1);
    ...
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("othello_SvD_B");
    resource = Common::TimeResource(1);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("othello_DvS_C");
    resource = Common::TimeResource(1);
    ...
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("othello_SvD_C");
    resource = Common::TimeResource(1);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("othello_DvS_D");
    resource = Common::TimeResource(1);
    ...
    auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("othello_SvD_D");
    resource = Common::TimeResource(1);
    ...
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("othello_DvS_E");
    resource = Common::TimeResource(1);
    ...
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("othello_SvD_E");
    resource = Common::TimeResource(1);
    ...
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("othello_DvS_F");
    resource = Common::TimeResource(1);
    ...
    auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("othello_SvD_F");
    resource = Common::TimeResource(1);
    ...
    auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("othello_DvS_G");
    resource = Common::TimeResource(1);
    ...
    auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("othello_SvD_G");
    resource = Common::TimeResource(1);
    ...
    auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("othello_DvS_H");
    resource = Common::TimeResource(1);
    ...
    auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("othello_SvD_H");
    resource = Common::TimeResource(1);
    ...
    auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("othello_DvS_I");
    resource = Common::TimeResource(1);
    ...
    auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("othello_SvD_I");
    resource = Common::TimeResource(1);
    ...
    auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("othello_DvS_J");
    resource = Common::TimeResource(1);
    ...
    auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("othello_SvD_J");
    resource = Common::TimeResource(1);
