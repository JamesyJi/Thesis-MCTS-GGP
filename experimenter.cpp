...
int main(void)
{
    ...
    // auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("othello_Fv1");
    // resource = Common::TimeResource(1);
    ...
    // auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("othello_1vF");
    // resource = Common::TimeResource(1);
    ...
    // auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("othello_Gv1");
    // resource = Common::TimeResource(1);
    ...
    // auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("othello_1vG");
    // resource = Common::TimeResource(1);
    ...
    // auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("othello_Hv1");
    // resource = Common::TimeResource(1);
    ...
    // auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("othello_1vH");
    // resource = Common::TimeResource(1);
    ...
    // auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("othello_Iv1");
    // resource = Common::TimeResource(1);
    ...
    // auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("othello_1vI");
    // resource = Common::TimeResource(1);
    ...
    auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("othello_Jv1");
    resource = Common::TimeResource(1);
    ...
    auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("othello_1vJ");
    resource = Common::TimeResource(1);
