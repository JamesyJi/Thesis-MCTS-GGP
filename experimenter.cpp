...
int main(void)
{
    ...
    // auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("othello_1v2");
    // resource = Common::TimeResource(1);
    // manager0.StartExperiment(resource, 200);

    // using Model3T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth2>;
    // using Model4T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth1>;
    // auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("othello_2v1");
    // resource = Common::TimeResource(1);
    ...
    // auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("othello_1v3");
    // resource = Common::TimeResource(1);
    ...
    // auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("othello_3v1");
    // resource = Common::TimeResource(1);
    // manager3.StartExperiment(resource, 200);

    // using Model9T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth2>;
    // using Model10T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    // auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("othello_2v3");
    // resource = Common::TimeResource(1);
    // manager4.StartExperiment(resource, 200);

    // using Model11T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    // using Model12T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth2>;
    // auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("othello_3v2");
    // resource = Common::TimeResource(1);
    ...
    resource = Common::TimeResource(1);
    manager0.StartExperiment(resource, 400);
    ...
    resource = Common::TimeResource(1);
    manager1.StartExperiment(resource, 400);
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("catchthelion_Dv4_B");
    resource = Common::TimeResource(1);
    manager2.StartExperiment(resource, 400);
    ...
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("catchthelion_4vD_B");
    resource = Common::TimeResource(1);
    manager3.StartExperiment(resource, 400);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("catchthelion_Dv4_C");
    resource = Common::TimeResource(1);
    manager4.StartExperiment(resource, 400);
    ...
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("catchthelion_4vD_C");
    resource = Common::TimeResource(1);
    manager5.StartExperiment(resource, 400);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("catchthelion_Dv4_D");
    resource = Common::TimeResource(1);
    manager6.StartExperiment(resource, 400);
    ...
    auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("catchthelion_4vD_D");
    resource = Common::TimeResource(1);
    manager7.StartExperiment(resource, 400);
    ...
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("catchthelion_Dv4_E");
    resource = Common::TimeResource(1);
    ...
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("catchthelion_4vD_E");
    resource = Common::TimeResource(1);
    manager9.StartExperiment(resource, 400);
    ...
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("catchthelion_Dv4_F");
    resource = Common::TimeResource(1);
    manager10.StartExperiment(resource, 400);
    ...
    auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("catchthelion_4vD_F");
    resource = Common::TimeResource(1);
    manager11.StartExperiment(resource, 400);
    ...
    // auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("catchthelion_Dv4_G");
    // resource = Common::TimeResource(1);
    // manager12.StartExperiment(resource, 400);
    ...
    // auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("catchthelion_4vD_G");
    // resource = Common::TimeResource(1);
    // manager13.StartExperiment(resource, 400);
    ...
    // auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("catchthelion_Dv4_H");
    // resource = Common::TimeResource(1);
    // manager14.StartExperiment(resource, 400);
    ...
    // auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("catchthelion_4vD_H");
    // resource = Common::TimeResource(1);
    // manager15.StartExperiment(resource, 400);

    // using Model33T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnI<StateT>>;
    // using Model34T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth4>;
    // auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("catchthelion_Dv4_I");
    // resource = Common::TimeResource(1);
    // manager16.StartExperiment(resource, 400);

    // using Model35T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth4>;
    // using Model36T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnI<StateT>>;
    // auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("catchthelion_4vD_I");
    // resource = Common::TimeResource(1);
    // manager17.StartExperiment(resource, 400);

    // using Model37T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnJ<StateT>>;
    // using Model38T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth4>;
    // auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("catchthelion_Dv4_J");
    // resource = Common::TimeResource(1);
    // manager18.StartExperiment(resource, 400);

    // using Model39T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth4>;
    // using Model40T = Models::Minimax::MinimaxSelection<GameT, Strategy::DepthFromTurnJ<StateT>>;
    // auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("catchthelion_4vD_J");
    // resource = Common::TimeResource(1);
    // manager19.StartExperiment(resource, 400);
