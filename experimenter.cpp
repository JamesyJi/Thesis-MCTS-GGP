...
int main(void)
{
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("catchthelion_Sv1");
    resource = Common::TimeResource(1);
    ...
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("catchthelion_2vS");
    resource = Common::TimeResource(1);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("catchthelion_Sv2");
    resource = Common::TimeResource(1);
    ...
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("catchthelion_3vS");
    resource = Common::TimeResource(1);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("catchthelion_Sv3");
    resource = Common::TimeResource(1);
    ...
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("catchthelion_Sv4");
    resource = Common::TimeResource(1);
    ...
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("catchthelion_5vS");
    resource = Common::TimeResource(1);
    ...
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("catchthelion_Sv5");
    resource = Common::TimeResource(1);
    ...
    auto manager11 = Main::GameManager<Model23T, Model24T, StateT, MoveT>("catchthelion_6vS");
    resource = Common::TimeResource(1);
    ...
    auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("catchthelion_Sv6");
    resource = Common::TimeResource(1);
    ...
    auto manager13 = Main::GameManager<Model27T, Model28T, StateT, MoveT>("catchthelion_7vS");
    resource = Common::TimeResource(1);
    ...
    auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("catchthelion_Sv7");
    resource = Common::TimeResource(1);
    ...
    auto manager15 = Main::GameManager<Model31T, Model32T, StateT, MoveT>("catchthelion_8vS");
    resource = Common::TimeResource(1);
    ...
    auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("catchthelion_Sv8");
    resource = Common::TimeResource(1);
