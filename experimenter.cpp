...
int main(void)
{
    ...
    // auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("breakthrough_Dv3_I");
    // resource = Common::TimeResource(1);
    ...
    // auto manager17 = Main::GameManager<Model35T, Model36T, StateT, MoveT>("breakthrough_3vD_I");
    // resource = Common::TimeResource(1);
    ...
    // auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("breakthrough_Dv3_J");
    // resource = Common::TimeResource(1);
    ...
    // auto manager19 = Main::GameManager<Model39T, Model40T, StateT, MoveT>("breakthrough_3vD_J");
    // resource = Common::TimeResource(1);
