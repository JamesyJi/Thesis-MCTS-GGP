...
int main(void)
{
    ...
    auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("connect4_4v3");
    resource = Common::TimeResource(1);
    manager0.StartExperiment(resource, 100);

    using Model3T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    using Model4T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth4>;
    auto manager1 = Main::GameManager<Model3T, Model4T, StateT, MoveT>("connect4_3v4");
    resource = Common::TimeResource(1);
    manager1.StartExperiment(resource, 100);

    using Model5T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth5>;
    using Model6T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("connect4_5v3");
    resource = Common::TimeResource(1);
    manager2.StartExperiment(resource, 100);

    using Model7T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    using Model8T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth5>;
    auto manager3 = Main::GameManager<Model7T, Model8T, StateT, MoveT>("connect4_3v5");
    resource = Common::TimeResource(1);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("connect4_6v3");
    resource = Common::TimeResource(1);
    manager4.StartExperiment(resource, 100);

    using Model11T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    using Model12T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth6>;
    auto manager5 = Main::GameManager<Model11T, Model12T, StateT, MoveT>("connect4_3v6");
    resource = Common::TimeResource(1);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("connect4_7v3");
    resource = Common::TimeResource(1);
    manager6.StartExperiment(resource, 100);

    using Model15T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    using Model16T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth7>;
    auto manager7 = Main::GameManager<Model15T, Model16T, StateT, MoveT>("connect4_3v7");
    resource = Common::TimeResource(1);
    manager7.StartExperiment(resource, 100);

    using Model17T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth8>;
    using Model18T = Models::Minimax::MinimaxSelection<GameT, Strategy::FixedDepth3>;
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("connect4_8v3");
    resource = Common::TimeResource(1);
    ...
    auto manager9 = Main::GameManager<Model19T, Model20T, StateT, MoveT>("connect4_3v8");
    resource = Common::TimeResource(1);
    ...
    // resource = Common::TimeResource(1);
    // manager17.StartExperiment(resource, 100);
    ...
    // resource = Common::TimeResource(1);
    // manager18.StartExperiment(resource, 100);
    ...
    // resource = Common::TimeResource(1);
    // manager19.StartExperiment(resource, 100);
