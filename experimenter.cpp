...
int main(void)
{
    ...
    auto manager0 = Main::GameManager<Model1T, Model2T, StateT, MoveT>("connect4_Dv1_A");
    resource = Common::TimeResource(1);
    ...
    auto manager2 = Main::GameManager<Model5T, Model6T, StateT, MoveT>("connect4_Dv1_B");
    resource = Common::TimeResource(1);
    ...
    auto manager4 = Main::GameManager<Model9T, Model10T, StateT, MoveT>("connect4_Dv1_C");
    resource = Common::TimeResource(1);
    ...
    auto manager6 = Main::GameManager<Model13T, Model14T, StateT, MoveT>("connect4_Dv1_D");
    resource = Common::TimeResource(1);
    ...
    auto manager8 = Main::GameManager<Model17T, Model18T, StateT, MoveT>("connect4_Dv1_E");
    resource = Common::TimeResource(1);
    ...
    auto manager10 = Main::GameManager<Model21T, Model22T, StateT, MoveT>("connect4_Dv1_F");
    resource = Common::TimeResource(1);
    ...
    auto manager12 = Main::GameManager<Model25T, Model26T, StateT, MoveT>("connect4_Dv1_G");
    resource = Common::TimeResource(1);
    ...
    auto manager14 = Main::GameManager<Model29T, Model30T, StateT, MoveT>("connect4_Dv1_H");
    resource = Common::TimeResource(1);
    ...
    auto manager16 = Main::GameManager<Model33T, Model34T, StateT, MoveT>("connect4_Dv1_I");
    resource = Common::TimeResource(1);
    ...
    auto manager18 = Main::GameManager<Model37T, Model38T, StateT, MoveT>("connect4_Dv1_J");
    resource = Common::TimeResource(1);
