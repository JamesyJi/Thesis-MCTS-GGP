...
public:
    ...
    void ExecuteStrategy()
    {
        ...
        auto [evaluation, depth] = Model<MinimaxRollout<TTraits, DepthFunc>, TTraits>::Simulate(exploreNode);
    ...
    MoveT SimulationPolicy(StateT& simulateState, const Common::Player playerTurn) const
    {
        ...
        for (int i = 0; i < nLegalMoves; ++i)
        {
            ...
            auto evaluation = this->MinimaxAB(simulateState, legalMoves[i], DepthFunc(1), Common::Result::PLAYER2_WIN, Common::Result::PLAYER1_WIN, Common::GetOtherPlayer(playerTurn));
