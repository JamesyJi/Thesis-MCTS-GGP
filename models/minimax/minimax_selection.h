...
public:
    ...
    void ExecuteStrategy()
    {
        ...
        auto [evaluation, depth] = Model<MinimaxSelection<TTraits, DepthFunc>, TTraits>::Simulate(exploreNode);
    ...
    NodeT& SelectBestChild()
    {
        ...
        while (bestChild->HasChildren())
        {
            ...
            {
                auto evaluation = this->MinimaxAB(bestChild->GetStateRef(), bestChild->GetLastMove(), DepthFunc(bestChild->GetAvgDepth()), Common::Result::PLAYER2_WIN, Common::Result::PLAYER1_WIN, bestChild->GetPlayerTurn());
